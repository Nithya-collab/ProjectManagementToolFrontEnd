export const FETCH_ISSUE_REQUEST = 'FETCH_ISSUES_REQUEST'
export const FETCH_ISSUE_SUCCESS = 'FETCH_ISSUES_SUCCESS'
export const FETCH_ISSUE_FAILURE = 'FETCH_ISSUES_FAILURE'
